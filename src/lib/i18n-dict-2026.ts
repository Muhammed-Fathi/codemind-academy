...
export const DICT_2026: Record<string, DictEntry> = {
  ...
  // Phase H — the admin progression-override console (appended: the admin
  // navigation order is pinned by earlier suites).
  "shell.h1": { ar: "استثناءات التقدم", en: "Progression overrides" },
  ...
  // ---------------- Phase H — canonical progression ----------------
  // Student-facing vocabulary. NEVER a raw database enum: every string below
  // is what a student actually reads when something is locked or incomplete.
  "progression.state.locked": { ar: "مقفول", en: "Locked" },
  "progression.state.unlocked": { ar: "مفتوح", en: "Open" },
  "progression.state.completed": { ar: "مكتمل", en: "Completed" },
  "progression.reason.video": { ar: "أكمل الفيديو الأول", en: "Finish the video first" },
  "progression.reason.quiz": { ar: "لازم تنجح في الـQuiz", en: "You need to pass the quiz" },
  "progression.reason.homework": { ar: "سلّم الـHomework الأول", en: "Submit the homework first" },
  "progression.reason.previous": { ar: "خلص الجلسة اللي قبلها الأول", en: "Finish the previous session first" },
  "progression.reason.hold": { ar: "عندك غياب محتاج تعويض", en: "You have an absence that needs catch-up" },
  "progression.reason.override": { ar: "الإدارة فتحتلك الجلسة دي كاستثناء", en: "The admin opened this session for you as an exception" },
  "progression.unmet.video": { ar: "الفيديو", en: "Video" },
  "progression.unmet.quiz": { ar: "الـQuiz", en: "Quiz" },
  "progression.unmet.homework": { ar: "الـHomework", en: "Homework" },
  "progression.unmet.previous": { ar: "الجلسة السابقة", en: "Previous session" },
  "progression.unmet.hold": { ar: "غياب محتاج تعويض", en: "Absence catch-up" },
  "progression.action.video": { ar: "كمّل الفيديو لحد 95% على الأقل", en: "Watch at least 95% of the video" },
  "progression.action.quiz": { ar: "احل الـQuiz واجتاز درجة النجاح", en: "Take the quiz and reach the pass mark" },
  "progression.action.homework": { ar: "سلّم الـHomework", en: "Submit the homework" },
  "progression.action.previous": { ar: "خلص متطلبات الجلسة اللي قبلها", en: "Complete the previous session requirements" },
  "progression.action.hold": { ar: "خلص متطلبات الجلسة اللي غبت عنها", en: "Complete the requirements of the session you missed" },
  "progression.requirements.title": { ar: "متطلبات الجلسة", en: "Session requirements" },
  "progression.next.title": { ar: "الخطوة الجاية", en: "Next step" },
  "progression.empty": { ar: "مفيش متطلبات على الجلسة دي", en: "This session has no requirements" },
  "progression.hold.banner": {
    ar: "عندك غياب محتاج تعويض. الجلسة الحالية ومحتواها مفتوحين عشان تقدر تعوّض.",
    en: "You have an absence that needs catch-up. The current session and its content stay open so you can catch up.",
  },
  "progression.catchup.title": { ar: "التعويض", en: "Catch-up" },
  "progression.catchup.cta": { ar: "أنا خلصت التعويض", en: "I finished the catch-up" },
  "progression.catchup.resolved": { ar: "تم تسجيل التعويض.. كمل", en: "Catch-up recorded — you can continue" },
  "progression.catchup.alreadyResolved": { ar: "التعويض كان متسجل قبل كده", en: "The catch-up was already recorded" },
  "progression.catchup.notSatisfied": { ar: "لسه فيه حاجات ناقصة في التعويض", en: "The catch-up is not complete yet" },
  "progression.catchup.noHold": { ar: "مفيش غياب محتاج تعويض", en: "No absence needs catch-up" },
  "progression.override.banner": {
    ar: "الإدارة فتحتلك الجلسة دي كاستثناء — الحالة الأكاديمية زي ما هي.",
    en: "The admin opened this session for you as an exception — your academic state is unchanged.",
  },

  // ---------------- Phase H — admin progression overrides ----------------
  "admin.progression.title": { ar: "استثناءات التقدم", en: "Progression overrides" },
  "admin.progression.hint": {
    ar: "الاستثناء بيفتح حدود التقدم بس — مش بيغير أي حاجة أكاديمية.",
    en: "An override only opens the progression boundary — it changes no academic fact.",
  },
  "admin.progression.adminOnly": { ar: "الأدمن بس يقدر يعمل كده", en: "Only an admin can do this" },
  "admin.progression.studentRequired": { ar: "اختار الطالب والجلسة", en: "Pick a student and a session" },
  "admin.progression.lessonNotFound": { ar: "الجلسة مش موجودة", en: "Session not found" },
  "admin.progression.reasonRequired": { ar: "لازم تكتب سبب للاستثناء", en: "A reason is required for the override" },
  "admin.progression.expiryInvalid": { ar: "تاريخ الانتهاء لازم يكون في المستقبل", en: "The expiry must be a future date" },
  "admin.progression.notFound": { ar: "الاستثناء مش موجود", en: "Override not found" },
  "admin.progression.lesson": { ar: "الجلسة", en: "Session" },
  "admin.progression.reason": { ar: "السبب", en: "Reason" },
  "admin.progression.expiry": { ar: "ينتهي في (اختياري)", en: "Expires at (optional)" },
  "admin.progression.issue": { ar: "إصدار الاستثناء", en: "Issue the override" },
  "admin.progression.revoke": { ar: "إلغاء الاستثناء", en: "Revoke the override" },
  "admin.progression.created": { ar: "تم إصدار الاستثناء", en: "Override issued" },
  "admin.progression.revoked": { ar: "تم إلغاء الاستثناء", en: "Override revoked" },
  "admin.progression.empty": { ar: "مفيش استثناءات", en: "No overrides" },
  "admin.progression.active": { ar: "ساري", en: "Active" },
  "admin.progression.expired": { ar: "منتهي", en: "Expired" },
  "admin.progression.revokedState": { ar: "ملغي", en: "Revoked" },
  "admin.progression.by": { ar: "بواسطة", en: "By" },
  "admin.progression.holdActive": { ar: "فيه تعويض قايم", en: "There is an active hold" },
  // The admin console (Phase H) — the console writes nothing academic, so the
  // copy says so out loud before the first override is ever issued.
  "admin.progression.search": { ar: "ابحث بالاسم أو كود الطالب", en: "Search by name or student code" },
  "admin.progression.student": { ar: "الطالب", en: "Student" },
  "admin.progression.pickStudent": { ar: "اختار طالب الأول عشان تشوف حد التقدم بتاعه", en: "Pick a student to see their progression boundary" },
  "admin.progression.current": { ar: "الجلسة الحالية", en: "Current session" },
  "admin.progression.boundary": { ar: "حد التقدم", en: "Progression boundary" },
  "admin.progression.noBoundary": { ar: "مفيش حاجة بتمنع الطالب دلوقتي", en: "Nothing is blocking this student right now" },
  "admin.progression.state": { ar: "الحالة", en: "State" },
  "admin.progression.issuedAt": { ar: "صدر في", en: "Issued at" },
  "admin.progression.revokeReason": { ar: "سبب الإلغاء (اختياري)", en: "Revocation reason (optional)" },
  "admin.progression.neverExpires": { ar: "بدون تاريخ انتهاء", en: "No expiry" },
  "admin.progression.history": { ar: "سجل الاستثناءات", en: "Override history" },
  "admin.progression.warning": {
    ar: "الاستثناء بيفتح حدود التقدم بس: مش بينشئ محاولة اختبار، ولا تسليم واجب، ولا مشاهدة فيديو، ولا بيلغي تعويض غياب.",
    en: "An override only opens the progression boundary: it creates no quiz attempt, no homework submission, no watch progress and it does not clear an absence hold.",
  },
};
