...
// Storage-value predicates live in the CLIENT-SAFE `./media-storage` module
// (pure string comparisons — see its header). Re-exported here so every
// existing `@/lib/media` importer keeps working unchanged.
import {
  MEDIA_STORAGE_VALUES,
  MANAGED_PRIVATE_STORAGE_VALUES,
...
export type { MediaStorageValue, ManagedPrivateStorageValue };
