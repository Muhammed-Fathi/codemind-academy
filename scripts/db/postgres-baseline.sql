...
CREATE TABLE "ProgressionOverride" (
  ...
  CONSTRAINT "ProgressionOverride_createdByUserId_fkey" FOREIGN KEY ("createdByUserId") REFERENCES "User" ("id") ON UPDATE CASCADE ON DELETE CASCADE,
  CONSTRAINT "ProgressionOverride_revokedByUserId_fkey" FOREIGN KEY ("revokedByUserId") REFERENCES "User" ("id") ON UPDATE CASCADE ON DELETE SET NULL
);
