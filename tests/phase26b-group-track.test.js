...
async function main() {
  ...
  // ---------------------------------------------------------------------------
  {
    ...
    eq(
      migs.length,
      19,
      "B1: history is 19 (10 PR-era + Phase 26B audience + Phase 26D quiz architecture + Phase F live sessions + Phase G x2 + Phase H override + session-video requirement + requirement modes + readiness-reminder recipients)"
    );
