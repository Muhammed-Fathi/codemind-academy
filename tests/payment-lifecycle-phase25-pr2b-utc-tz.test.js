...
fs.writeFileSync(
  ...
  [
    ...
    "  return {",
    "    id: s.id, userId: s.userId, groupId: s.groupId ?? null, schoolType: s.schoolType ?? null,",
    ...
    "  store.students.push({ id: 'stu-a', userId: 'u-a', groupId: 'g1', schoolType: 'ARABIC' });",
    ...
    "  const store = freshStore();",
    "  store.students.push({ id: 'stu-b', userId: 'u-b', groupId: 'g1', schoolType: 'ARABIC' });",
    ...
    "  const store = freshStore();",
    "  store.students.push({ id: 'stu-c', userId: 'u-c', groupId: null, schoolType: 'ARABIC' });",
